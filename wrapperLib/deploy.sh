...
rsync ./dist/assets/ user1@194.146.25.179:/home/user1/prebid_wrapper/dist/$version/ -r
rsync ./dist/assets/ user1@194.146.25.179:/home/user1/prebid_wrapper/dist/latest/ -r
